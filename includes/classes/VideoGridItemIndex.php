...
class VideoGridItemIndex {
    ...
    public function createForIndex() {
        $thumbnail = $this->createThumbnailForIndex();
        $details = $this->createDetailsForIndex();
    ...
    private function createThumbnailForIndex() {
    ...
    private function createDetailsForIndex() {
        $title = $this->video->getTitle();
        $username = $this->video->getUploadedBy();
        $views = $this->video->getViews();
        $description = $this->createDescriptionIndex();
    ...
    private function createDescriptionIndex() {
        if(!$this->largeMode) {
            return "";
        }
        else {
